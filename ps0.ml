...
let name : (string * string) = ("Doug", "Yang");;
...
let my_system : system = Mac;;



(* 5. Replace the string below with a message to post to the problem
   set website. *)
let exciting : string = "I'm excited to learn how to write good code and use Ocaml" ;;
...
(* 8. Please complete the start-of-term survey for the course,
   available at <https://url.cs51.io/startsurvey>. When you have completed
   the survey, set this variable to true. *)
